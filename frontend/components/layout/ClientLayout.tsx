...
export const ClientLayout = ({ 
  ...
  namespace = ['client', 'common', 'layout'],
  suffix = '| ThinkForward AI'
}: ClientLayoutProps) => {
  const { t } = useTranslation(['client', 'common', 'layout']);
  ...
  const title = titleKey 
    ...
    : defaultTitle 
      ? `${defaultTitle} ${suffix}` 
      : `ThinkForward AI - ${t('client.dashboard_title')}`;
  ...
  const navigation = [
    { 
      ...
      icon: HomeIcon, 
      current: router.pathname === '/client/dashboard' 
    },
    { 
      name: t('navigation.documents'), 
      href: '/client/documents', 
      icon: DocumentTextIcon, 
      current: router.pathname.startsWith('/client/documents') 
    },
    { 
      name: t('navigation.ai_assistant'), 
      href: '/client/ai-assistant', 
      icon: ChatBubbleLeftRightIcon, 
      current: router.pathname === '/client/ai-assistant' 
    },
    { 
      name: t('navigation.appointments'), 
      href: '/client/appointments', 
      icon: CalendarIcon, 
      current: router.pathname.startsWith('/client/appointments') 
    },
    { 
      name: t('navigation.profile'), 
      href: '/client/profile', 
      icon: UserIcon, 
      current: router.pathname === '/client/profile' 
    },
    { 
      name: t('navigation.settings'), 
      href: '/client/settings', 
      icon: Cog6ToothIcon, 
      current: router.pathname === '/client/settings' 
    },
  ];
  ...
  return (
    <RTLWrapper>
      <Head>
        <title>{title}</title>
        <meta name="description" content={t('layout:client.meta_description') as string} />
