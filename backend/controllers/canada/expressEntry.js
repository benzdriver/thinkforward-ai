...
exports.calculatePoints = async (req, res) => {
  try {
    ...
    const score = calculateCRSScore(profile);
    ...
    return res.status(500).json({ 
      success: false, 
      message: 'Failed to calculate Express Entry points',
      error: error.message
    });
  }
};
...
exports.getLatestDraws = async (req, res) => {
  try {
    ...
    return res.status(500).json({ 
      success: false, 
      message: 'Failed to fetch latest draws',
      error: error.message
    });
  }
};
...
exports.saveProfile = async (req, res) => {
  try {
    ...
    const profile = new ExpressEntryProfile({
      ...
      crsScore: calculateCRSScore(profileData),
    ...
    return res.status(500).json({
      success: false,
      message: 'Failed to save Express Entry profile',
      error: error.message
    });
  }
};
...
exports.getProfile = async (req, res) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      message: 'Failed to fetch Express Entry profile',
      error: error.message
    });
  }
};

function calculateCRSScore(profile) {
  let score = 0;
